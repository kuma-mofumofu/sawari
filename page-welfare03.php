    ...
    <main id="page-living" class="businesses">
      ...
      <section id="living-top" >
        ...
        <div class="about-outer">
            <p>共同生活援助は障碍者グループホームのことで、障碍福祉サービスのひとつです。施設には家事援助や日常生活での相談を受ける世話人、食事や入浴、トイレなどの介護支援を行う生活支援員などの職員がいて、日常生活上の援助や介護支援を受けながら共同生活を送れることができます。</p>
        </div>
      </section>
        ...
        <div class="businesses-inner">
          ...
          <ul>
              <li>
                  ...
                  <div class="text">
                      <h5>体験利用</h5>
                      <p>まずはお住いの区の障碍基幹相談支援センター、保健センター、地域福祉課、指定相談支援事業所などを通じて体験利用のご連絡をください。体験したい日や利用時間はご希望に合わせます。希望があれば、送迎も承りますのでお申し付けください。</p>
                  </div>
              </li>
              <li>
                  <span>2</span>
                  <div class="text">
                      <h5>契約手続き</h5>
                      <p>体験利用で施設を気に入ってもらえれば、ご利用に関する契約手続きを進め、利用開始日や回数等の調整を行います。</p>
                  </div>
              </li>
              <li>
                  <span>3</span>
                  <div class="text">
                      <h5>ご利用開始</h5>
                      <p>契約書の手続きが完了すれば利用開始へ。自分のペースの楽しい時間を一緒に過ごしましょう！</p>
                  </div>
              </li>
          </ul>
        </div>
