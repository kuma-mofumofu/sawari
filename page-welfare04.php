      ...
      <section id="consultation-top" >
        ...
        <div class="businesses-inner">
            <dl>
                <div>
                    <dt>対象となる方</dt>
                    <dd>障碍福祉サービスを申請した障害者又は障害児であって、市町村がサービス等利用計画案の提出を求めた方 <br>
    地域相談支援を申請した障害者であって市町村がサービス等利用計画案の提出を求めた方 <br>
    なお、介護保険制度のサービスを利用する場合には、障害福祉サービス固有の行動援護、同行援護、自立訓練（生活訓練）、就労移行支援、就労継続支援等を利用している方で、市町村が必要と認める場合に対象となります。</dd>
                </div>
                <div>
                    <dt>ご利用料金</dt>
          ...
          <div class="businesses-inner">
            <ul>
                <li>
                    ...
                    <div class="text">
                        <h5>相談</h5>
                        <p>障害のある方ご本人の意向、お悩みや課題などをお聞きしながら必要なサービスや状況を整理します。</p>
                    </div>
                </li>
                <li>
                    <span>2</span>
                    <div class="text">
                        <h5>計画</h5>
                        <p>相談支援専門員がご相談を元にサービス等利用計画案・障害児支援利用計画案（プランニング）を作成します。</p>
                    </div>
                </li>
                <li>
                    <span>3</span>
                ...
                <li>
                    ...
                    <div class="text">
                        <h5>決定</h5>
                        <p>作成したサービス利用計画案・障害児支援利用計画案などをもとに、申請を行った後に支給の決定を受けます。</p>
                    </div>
                </li>
                <li>
                    <span>5</span>
                ...
                <li>
                    ...
                    <div class="text">
                        <h5>開始</h5>
                        <p>会議で確定したサービス等利用計画・障害児支援利用計画を市区町村に提出し、サービスの利用を開始します。</p>
                    </div>
                </li>
             </ul>
            </div>
